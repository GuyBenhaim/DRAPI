...
namespace WebServiceApp
{
    ...
    //{
        ...
        //    DatabaseGateway da = new DatabaseGateway();
        //    int result = 0;
        //    result = (int)da.ExecuteScalar("proc_EventSave", _event_ID, _event_Type_ID, _Event_TextRoute_ID, _user_ID, _device_ID, _event_Time, _event_Location, _event_Bearing, _object_ID,_event_CreatedDate);
        //    return result;
        //}
